...
from src.models.lstm import IntelliCrashLSTM, IMUDataset, FocalLoss
...
def export_to_onnx(model, dummy_input_shape=(1, 200, 24)):
    cfg = get_config()
...
if __name__ == "__main__":
    ...
    trained_model.load_state_dict(torch.load(Path(get_config()["paths"]["model_checkpoints"]) / "best_lstm.pth"))
